...
# make sure the camera is working. if not, return false
def checkCamera(x):
...
# check to make sure the camera is hooked up and works
# if not, exit the program
working = checkCamera(0)
if working == False:
	sys.exit("\n\ncamera doesn't appear to be hooked up or change argument to checkCamera function to 1")
